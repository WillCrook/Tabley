      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <a href="#" onClick={(e) => { e.preventDefault(); window.scrollTo(0,0); }} className="text-2xl font-bold tracking-tighter text-zinc-900">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-b border-zinc-100 absolute w-full">
          <div className="px-4 pt-2 pb-6 space-y-4 flex flex-col">
            <a 
              href="#features" 
              className="block px-3 py-2 text-base font-medium text-zinc-900 hover:bg-zinc-50 rounded-md"
