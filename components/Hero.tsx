...
const Hero: React.FC<HeroProps> = ({ onBookDemo }) => {
  ...
  <Button
    ...
    size="lg"
    variant="primary"
    className="h-14 px-8 text-lg shadow-xl shadow-emerald-500/20 hover:shadow-emerald-500/30 border-0 w-full sm:w-auto"
  >
    Start Free Trial
  </Button>

  <a href="https://app.tabley.info" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
    <Button
      size="lg"
      variant="outline"
      className="h-14 px-8 text-lg bg-white border-zinc-200 text-zinc-700 hover:bg-zinc-50 hover:border-zinc-300 w-full"
    >
      View Live Demo
    </Button>
  </a>
